...
public partial class CheckoutInvoiceWindow : Window
{
    private readonly BookingReservation _reservation;

    public decimal InvoiceTotal { get; private set; }

    public CheckoutInvoiceWindow(BookingReservation reservation)
    {
        InitializeComponent();
    ...
    private void LoadData()
    {
        ...
        InvoiceTotal = rows.Sum(row => decimal.Parse(row.LineTotal, NumberStyles.Number, CultureInfo.CurrentCulture));
